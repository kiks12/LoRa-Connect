...
import { EvacuationCenters, OperationStatus, Owners, Rescuers, RescueUrgency } from "@prisma/client";
														...
														<CommandGroup>
															{evacuationCenters.map((evacuationCenter, index) => (
																...
																>
																	...
																	<Check
																		className={cn("ml-auto", evacuationCentersSearchValue === evacuationCenter.name ? "opacity-100" : "opacity-0")}
																	/>
																</CommandItem>
															))}
														</CommandGroup>
